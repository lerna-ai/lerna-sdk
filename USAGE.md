...
lerna.triggerInference(
                       ...
                       String predictionClass (optional),
                       int numElements (optional default 1))
```
...
All queries are personalized and use the unique user identifier that was configured with [Setup/Update of User Identification](#setupupdate-of-user-identification) function, or auto generated by Lerna Library.
...
To submit a success event to the Recommendation engine you use the same call that captures the event in the library as described [here](#informing-the-library-of-a-success-event).

<div style="height: 110px"></div>
  <p align="center">
    © All Rights Reserved. Lerna Inc. 2024.
  </p>
