...
internal class MLInferenceTest {
	...
	fun `predictLabelScoreMulLinesMulItems`() {
		...
		assertEquals(2.8139684f, result?.get("first"))
		assertEquals(1.0093684f, result?.get("second"))
		assertEquals(0.6545533f, result?.get("third"))
	}
