...
//	}
	...
	internal fun toArray(): Array<Float> {
		...
		doubleArray.add(linAcceleration[0])
		doubleArray.add(linAcceleration[1])
		doubleArray.add(linAcceleration[2])
		doubleArray.add(gyroscope[0])
		doubleArray.add(gyroscope[1])
		doubleArray.add(gyroscope[2])
		doubleArray.add(magneticField[0])
		doubleArray.add(magneticField[1])
		doubleArray.add(magneticField[2])
		doubleArray.add(linAccelerationMean[0])
		doubleArray.add(linAccelerationMean[1])
		doubleArray.add(linAccelerationMean[2])
		doubleArray.add(gyroscopeMean[0])
		doubleArray.add(gyroscopeMean[1])
		doubleArray.add(gyroscopeMean[2])
		doubleArray.add(magneticFieldMean[0])
		doubleArray.add(magneticFieldMean[1])
		doubleArray.add(magneticFieldMean[2])
		doubleArray.add(linAccelerationStd[0])
		doubleArray.add(linAccelerationStd[1])
		doubleArray.add(linAccelerationStd[2])
		doubleArray.add(gyroscopeStd[0])
		doubleArray.add(gyroscopeStd[1])
		doubleArray.add(gyroscopeStd[2])
